 ...
 * @author ccami
 */
@WebServlet(name = "MakeAppointmentServlet", urlPatterns = {"/MakeAppointmentServlet"})
public class MakeAppointmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           //if there is no appointment , make one else send to view appointment 
           if(Date != null && !Date.isEmpty()){
           apt.insertDB(Date, p1.getPatID(), Dentist, Procode);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MakeAppointmentServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
